                ...
                For Each runningPayload In inputPayload
                    ...
                    If lastHighUCandle IsNot Nothing AndAlso lastHighUCandle.Item1 IsNot Nothing Then
                        ...
                        If firstHighUCandle IsNot Nothing AndAlso firstHighUCandle.Item1 IsNot Nothing Then
                            ...
                            End If
                        Else
                            Dim previousHighLine As TrendLineVeriables = outputHighPayload(runningPayload.Value.PreviousPayload.PayloadDate)
                    ...
                    If lastLowUCandle IsNot Nothing AndAlso lastLowUCandle.Item1 IsNot Nothing Then
                        ...
                        If firstLowUCandle IsNot Nothing Then
                            ...
                            End If
                        Else
                            Dim previousLowLine As TrendLineVeriables = outputLowPayload(runningPayload.Value.PreviousPayload.PayloadDate)
