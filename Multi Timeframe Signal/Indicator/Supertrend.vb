            ...
            If inputPayload IsNot Nothing AndAlso inputPayload.Count > 0 Then
                ...
                If atrPayload IsNot Nothing AndAlso atrPayload.Count > 0 Then
                    ...
                    For Each runningInputPayload In inputPayload.Keys
                        If inputPayload(runningInputPayload).PreviousPayload IsNot Nothing Then
                            ...
                            finalUpperband = If(basicUpperband < previousFinalUpperband Or inputPayload(runningInputPayload).PreviousPayload.Close > previousFinalUpperband, basicUpperband, previousFinalUpperband)
                            finalLowerband = If(basicLowerband > previousFinalLowerband Or inputPayload(runningInputPayload).PreviousPayload.Close < previousFinalLowerband, basicLowerband, previousFinalLowerband)
